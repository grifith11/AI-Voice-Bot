...
# Setup OpenAI
openai.api_key = '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'
...
def generate_questions(document_content, num_questions=5):
    try:
...
def create_gui():
    ...
    canvas = Canvas(root, width=1000, height=1000, bg=background_color)
...
if __name__ == "__main__":
    file_path = r"DunkinDonuts.txt"  # Adjust this to your file path
    create_gui()